...
import { aiMobileText } from "../../src/modules/ai/mobile/aiMobileI18n";
...
export default function ProfileAIScreen() {
  ...
  const aiItems: RowItem[] = [
    {
      ...
      icon: (
        <IconBox
          accent={BLUE}
          icon={<Languages size={19} color={BLUE} strokeWidth={2.5} />}
        />
      ),
    },
    {
      ...
      icon: (
        <IconBox
          accent={TEAL}
          icon={<Mic size={19} color={TEAL} strokeWidth={2.5} />}
        />
      ),
    },
    {
      ...
      icon: (
        <IconBox
          accent={PURPLE}
          icon={<Brain size={19} color={PURPLE} strokeWidth={2.5} />}
        />
      ),
    },
    {
      ...
      icon: (
        <IconBox
          accent={GOLD}
          icon={<Crown size={19} color={GOLD} strokeWidth={2.5} />}
        />
      ),
    },
  ];
  ...
  const profileItems: RowItem[] = [
    {
      ...
      icon: (
        <IconBox
          accent={TEAL}
          icon={<User size={19} color={TEAL} strokeWidth={2.5} />}
        />
      ),
    },
    {
      ...
      icon: (
        <IconBox
          accent={PURPLE}
          icon={<Palette size={19} color={PURPLE} strokeWidth={2.5} />}
        />
      ),
    },
    {
      ...
      icon: (
        <IconBox
          accent={BLUE}
          icon={<QrCode size={19} color={BLUE} strokeWidth={2.5} />}
        />
      ),
    },
  ];
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          <Pressable onPress={() => router.back()} style={styles.headerButton}>
            <ArrowLeft size={19} color={TEXT} strokeWidth={2.5} />
          </Pressable>

          <View style={styles.headerCenter}>
            <View style={styles.headerIcon}>
              <Bot size={18} color={TEAL} strokeWidth={2.5} />
            </View>
          ...
          >
            <Bot size={19} color={TEXT} strokeWidth={2.5} />
          </Pressable>
        </View>
        ...
        >
          <View style={styles.statusCard}>
            <IconBox
              accent={GREEN}
              icon={<ShieldCheck size={19} color={GREEN} strokeWidth={2.5} />}
            />
