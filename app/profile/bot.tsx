...
import { syncSabiProfileBotToPublicDirectory, syncSabiProfileBotsCollectionToPublicDirectory } from "../../src/modules/messenger/public-directory/profileDirectoryBridge";
...
const loadData = useCallback(async () => {
  try {
    ...
    const bots = Array.isArray(collection?.items)
      ? collection.items.map((item) => normalizeBotState(item as Partial<BotProfileState>))
      : [];
