...
import { resetAuthenticatedSession } from "../src/core/kernel/auth/session.actions";
import {
  deleteAuthenticatedAccount,
  logoutAuthenticatedSession,
} from "../src/shared/api/auth-api";
import { shutdownMessengerKernel } from "../src/core/kernel/messenger";
import {
  ...
  PROFILE_USER,
} from "../src/modules/profile/data/profile";
import { useProfileRuntime } from "../src/modules/profile/data/profileRuntime";
import { useProfileKernel } from "../src/core/kernel/profile/bindings";
import { profileKernelFacade } from "../src/core/kernel/profile";
import { hydratePublicProfile, hydratePublicProfileStorage, subscribePublicProfiles } from "../src/modules/messenger/public/publicProfileRuntime";
import { syncCurrentProfilePublicSurface, syncCurrentProfilePublicSurfaceToBackend } from "../src/modules/messenger/public/publicProfileSync";
...
export default function ProfileScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      void profileKernel.refresh();
      const surface = syncCurrentProfilePublicSurface(profileKernel.state);
