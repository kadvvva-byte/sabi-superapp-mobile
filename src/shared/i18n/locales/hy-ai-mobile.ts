export const HY_AI_MOBILE_LOCALE = {
  ai: {
    mobile: {
      common: {
        back: "Back",
      ...
      home: {
        ...
        heroDescription:
          "The mobile UI is connected to the AI kernel contracts. No fake answers: if backend or provider is unavailable, the screen shows a real connection state.",
        quickAccess: "Quick access",
        capabilities: "Capabilities",
        safeActions: "Safe actions",
        safeActionsDescription:
          "AI-24 safety/admin monitoring is backend-owned and visible in admin panel contracts.",
        safeActionsText:
          "Money, account deletion and high-risk actions require confirmation and admin/compliance rules.",
        connection: "Connection",
        userId: "User ID",
        cleanWorkspaceTitle: "Clean AI workspace",
        cleanWorkspaceText:
          "Only useful AI functions for the user are shown here.",
      },
      ...
      chat: {
        ...
        cleanEmptyText:
          "Write a question, upload a file, speak by voice or enable web search.",
        ...
        assistantCenterDescription:
          "Clean chat with files, web search, business and study assistants.",
        ...
        assistantMenuSubtitle:
          "Business, student, applicant, teacher or universal AI.",
        ...
        mode: {
          ...
          business: {
            ...
            short: "Business",
            description:
              "Plans, documents, sales, support and business processes.",
          ...
          student: {
            ...
            short: "Student",
            description:
              "Topic explanations, tasks and step-by-step learning.",
          ...
          applicant: {
            ...
            short: "Applicant",
            description:
              "Admissions, exams, essays, interviews and university choice.",
          ...
          teacher: {
            ...
            short: "Teacher",
            description:
              "Lesson plans, materials, grading and classroom work.",
        ...
        toolsSubtitle:
          "Active mode: {mode}. Upload a file or enable web search.",
        toolsSheetTitle: "Additional functions",
        toolsSheetSubtitle:
          "Upload a photo, video, document or enable web search.",
        ...
        webSearchDescription:
          "Prepare the answer using web search.",
        ...
        uploadContractNotice:
          "Files are attached to the AI request and processed through the provider.",
        ...
        securityNotice:
          "AI will not send messages, money or important actions without your confirmation.",
      ...
      translation: {
        ...
        premium:
          "Premium gate stays in backend. The screen only displays the real response.",
        source: "Source text",
        ...
        messengerReady:
          "The path for Messenger chat text, audio transcripts and call subtitles is ready.",
      ...
      voice: {
        ...
        audioCapturedNotice:
          "Audio was captured and reported as a native voice event. Speech recognition must provide a real transcript; this screen does not invent one.",
      ...
      settings: {
        ...
        heroDescription:
          "Manage providers, locale, permissions and safety state.",
        ...
        safetyDescription:
          "Internal AI-24 reports, holds and critical escalation are backend/admin-panel owned.",
        providerTitle: "Provider contracts",
        providerDescription:
          "Google/Yandex/Internal provider settings are loaded from backend settings contracts.",
        controlTitle: "Controls",
        profileOwnerTitle: "Profile owner",
        profileOwnerDescription:
          "AI settings are linked to the verified profile owner.",
      ...
      memory: {
        ...
        noAccusation:
          "AI stores preferences only through the approved memory/personalization layer.",
        modeSaved: {
      ...
      premium: {
        ...
        realtimeTranslationDescription:
          "Premium gate: ai_translation_realtime. Actual permission comes from backend.",
        mediaTranslationTitle: "Media translation",
        mediaTranslationDescription:
          "Audio/video transcript translation through native bridge and backend provider.",
        advancedAssistantActionsTitle: "Advanced assistant actions",
        safeActionsTitle: "Safe actions",
        safeActionsDescription:
          "Money/account actions stay confirmation-gated and safety-controlled.",
      ...
      activity: {
        ...
        emptyTitle: "No items",
        emptyText:
          "The backend did not return items for this section yet.",
      },

      error: {
        ai_mobile_api_base_url_missing: "AI mobile API base URL is missing.",
        ai_mobile_auth_required:
          "AI mobile authorization is required.",
        ...
        ai_voice_audio_url_missing:
          "Voice audio URL is missing.",
      },
    },
  },
} as const;

export default HY_AI_MOBILE_LOCALE;