  ...
  ai: {
    mobile: {
      common: {
        ...
        open: "Открыть",
        refresh: "Обновить",
        requestFailed: "Запрос не выполнен. Повторите попытку.",
        retry: "Повторить",
        save: "Сохранить",
        saved: "Сохранено",
        search: "Поиск",
      ...
      home: {
        ...
        heroDescription:
          "AI чат · Голосовой AI · Перевод · Память · Premium AI.",
        quickAccess: "Быстрый доступ",
        capabilities: "Возможности",
        safeActions: "Безопасность",
      ...
      chat: {
        ...
        webSearch: "Интернет-поиск",
        webSearchShort: "Интернет-поиск",
        webSearchDescription:
          "Интернет-поиск",

        voiceRecording: "Голосовой AI",
        ...
        safetyConfirmTitle: "AI помощник",
        safetyConfirmMessage: "AI помощник",
        safetyConfirmCancel: "AI помощник",
        safetyConfirmContinue: "AI помощник",
        securityNotice:
          "AI помощник",
      ...
      translation: {
        ...
        subtitle: "Перевод",
        heroEyebrow: "Перевод",
        realtimeTitle: "Перевод",
        premium:
          "Premium AI",
        source: "Исходный текст",
        sourcePlaceholder: "Исходный текст",
        textPhotoCamera: "Исходный текст · Камера · Фото",
        target: "Язык перевода",
        targetPlaceholder: "Язык перевода",
        translate: "Перевод",
        result: "Результат",
        inputPlaceholder: "Исходный текст",
      ...
      voice: {
        ...
        realBridgeDescription:
          "Рэальны мабільны мост: запіс мікрафона, native галасавыя падзеі, перадача транскрыпта і прайграванне audio URL. Text-only TTS не імітуецца.",
        bind: "Подключение",
        start: "Начать",
        stop: "Остановить",
        invoke: "Отправить",
        ...
        noFakeTts:
          "Без фальшывага голасу: аўдыя прайграваецца толькі калі backend/native TTS вяртае audio URL. Text-only TTS паказваецца як тэкст, пакуль не падключаны expo-speech або native TTS module.",
        runtimeLog: "История",
        noEvents: "Пока пусто",
      ...
      settings: {
        ...
        subtitle: "Настройки",
        metricApi: "API",
        metricSource: "Исходный текст",
        sourceLocalContract: "Провайдер",
        connectionDetails: "Подключение",
        sections: "Возможности",
      ...
      memory: {
        ...
        adaptive: "Адаптивный",
        addInstruction: "Отправить",
        instructions: "Память",
        instructionPlaceholder: "Память",
        noAccusation:
          "Безопасность",
        modeSaved: {
          strict: "Сохранено",
      ...
      premium: {
        ...
        noFakePayment:
          "Аплата тут не імітуецца. Актывацыя павінна прыйсці з рэальнага патоку пацвярджэння Premium/COIN.",
        ...
        mediaTranslationDescription:
          "Перевод",
        advancedAssistantActionsTitle: "AI помощник",
        safeActionsTitle: "Безопасность",
        safeActionsDescription:
          "Безопасность",
      ...
      error: {
        ...
        ai_mobile_auth_required:
          "Ошибка",
        ai_mobile_request_failed: "Ошибка",
        ...
        ai_voice_empty_tts_text: "Ошибка",
...
export default BE_AI_MOBILE_LOCALE;