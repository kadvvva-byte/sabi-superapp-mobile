  ...
  ai: {
    mobile: {
      ...
      home: {
        ...
        heroDescription:
          "Chat, ovoz, tarjima, xotira va Premium AI bitta toza ish maydonida.",
        quickAccess: "Tezkor kirish",
        capabilities: "Funksiyalar",
        safeActions: "Xavfsizlik va ruxsatlar",
        safeActionsDescription:
          "AI muhim amallarni foydalanuvchi tasdig‘isiz bajarmaydi.",
        safeActionsText:
          "AI alohida dastur. Messenger va qo‘ng‘iroqlar keyin shu tarjima yo‘liga ulanadi.",
        connection: "Ulanish",
        userId: "Foydalanuvchi ID",
        cleanWorkspaceTitle: "Toza AI maydoni",
        cleanWorkspaceText:
          "Bu yerda faqat foydalanuvchi uchun kerakli AI funksiyalar ko‘rsatiladi.",
      },
      ...
      chat: {
        ...
        cleanEmptyText:
          "Savol yozing, fayl yuklang, ovoz bilan gapiring yoki internetdan qidirishni yoqing.",
        ...
        assistantCenterDescription:
          "Fayllar, internet qidiruvi, biznes va o‘qish yordamchilari bilan toza chat.",
        ...
        assistantMenuSubtitle:
          "Biznes, talaba, abituriyent, o‘qituvchi yoki universal AI.",
        ...
        mode: {
          ...
          business: {
            ...
            short: "Biznes",
            description:
              "Reja, hujjat, savdo, qo‘llab-quvvatlash va biznes jarayonlar.",
          ...
          student: {
            ...
            short: "Talaba",
            description:
              "Mavzuni tushuntirish, vazifa va bosqichma-bosqich o‘rganish.",
          ...
          applicant: {
            ...
            short: "Abituriyent",
            description:
              "Kirish, imtihon, esse, suhbat va universitet tanlash.",
          ...
          teacher: {
            ...
            short: "O‘qituvchi",
            description:
              "Dars rejasi, materiallar, baholash va sinf ishlari.",
        ...
        toolsSubtitle:
          "Faol rejim: {mode}. Fayl yuklang yoki internet qidiruvini yoqing.",
        toolsSheetTitle: "Qo‘shimcha funksiyalar",
        toolsSheetSubtitle:
          "Foto, video, hujjat yuklang yoki internet qidiruvini yoqing.",
        ...
        webSearchDescription:
          "Javobni internet qidiruvi orqali tayyorlash.",
        ...
        uploadContractNotice:
          "Fayllar AI so‘roviga biriktiriladi va provayder orqali qayta ishlanadi.",
        ...
        securityNotice:
          "AI xabar, pul yoki muhim amallarni sizning tasdiqingizsiz bajarmaydi.",
      ...
      translation: {
        ...
        premium:
          "Messenger keyin shu yo‘l orqali chat matni, audio va qo‘ng‘iroq subtitrlarini tarjima qiladi.",
        source: "Asl matn",
        ...
        messengerReady:
          "Messenger uchun chat matni, audio transkript va qo‘ng‘iroq subtitrlari yo‘li tayyor.",
      ...
      voice: {
        ...
        audioCapturedNotice:
          "Audio yozildi. Matnni ovoz provayderi qaytaradi.",
      ...
      settings: {
        ...
        heroDescription:
          "Bu yerda faqat ruxsatlar, til, Premium va xavfsizlik boshqaruvi ko‘rsatiladi.",
        ...
        safetyDescription:
          "Risk signallari foydalanuvchini ayblamasdan admin ko‘rib chiqishiga yuboriladi.",
        providerTitle: "Provayderlar",
        providerDescription:
          "Google/Yandex/ChatGPT yo‘li AI tizimi orqali boshqariladi.",
        controlTitle: "Boshqaruv qoidalari",
        profileOwnerTitle: "Ruxsatlar profilda",
        profileOwnerDescription:
          "AI tili, ruxsatlar va Premium profil orqali boshqariladi.",
      ...
      memory: {
        ...
        noAccusation:
          "AI foydalanuvchini ayblamaydi. Xavfsizlik signallari ichki ko‘rib chiqish uchun.",
        modeSaved: {
        ...
        instructionSaved:
          "Ko‘rsatma shaxsiylashtirish tizimiga yuborildi.",
      },
      ...
      premium: {
        ...
        realtimeTranslationDescription:
          "Matn, audio va qo‘ng‘iroq subtitrlari bitta AI yo‘lidan foydalanadi.",
        mediaTranslationTitle: "Media tarjimasi",
        mediaTranslationDescription:
          "Audio va video xabar tarjimasi Messenger uchun tayyorlanadi.",
        advancedAssistantActionsTitle: "Kengaytirilgan yordamchi amallari",
        safeActionsTitle: "Xavfsiz amallar",
        safeActionsDescription:
          "Kengaytirilgan amallar ruxsat, Premium va xavfsizlik qoidalari ostida ishlaydi.",
      ...
      error: {
        ...
        ai_voice_audio_url_missing:
          "Ovozli javob uchun audio URL kelmadi.",
      },
    },
  },
} as const;

export default TG_AI_MOBILE_LOCALE;