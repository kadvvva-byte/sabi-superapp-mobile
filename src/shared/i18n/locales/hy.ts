export const HY_LOCALE = {
  ...
  "common": {
    ...
    "closingBalance": "Վերջնական մնացորդ",
    "availableBalance": "Հասանելի մնացորդ",
    "currentBalance": "Ընթացիկ մնացորդ",
    "heldBalance": "Պահված մնացորդ",
    "reservedBalance": "Պահուստային մնացորդ",
    "pendingBalance": "Սպասման մնացորդ",
    "ledgerBalance": "Գրանցամատյանի մնացորդ",
  ...
  "status": {
    ...
    "archived": "Արխիվացված",
    "settled": "Հաշվանցված",
    "settling": "Հաշվանցման մեջ",
    "authorized": "Ավտորիզացված",
    "captured": "Գանձված",
    "reversed": "Հետադարձված",
    "refunded": "Վերադարձված",
    "disputed": "Վիճարկվող",
    "underReview": "Վերանայման տակ",
    "onHold": "Սպասեցված",
    "partiallySettled": "Մասնակի հաշվանցված"
  },
  "time": {
    "justNow": "Հենց նոր",
    ...
    "valueDate": "Արժեքի ամսաթիվ"
  },
  "languageScreen": {
    "title": "Հավելվածի լեզու",
    "subtitle": "Ընտրեք Sabi-ի ինտերֆեյսի լեզուն։",
    "searchPlaceholder": "Որոնել լեզու",
    "selectedLanguage": "Ընտրված լեզու",
    "systemLanguage": "Համակարգի լեզու",
    "appLanguage": "Հավելվածի լեզու",
    "suggestedLanguages": "Առաջարկվող լեզուներ",
    "allLanguages": "Բոլոր լեզուները",
    "languageSupport": "Լեզվական աջակցություն",
    "applyButton": "Կիրառել լեզուն",
    "changeSuccess": "Լեզուն թարմացվեց",
    "noLanguagesFound": "Լեզուներ չեն գտնվել",
    "rtlPreview": "Աջից ձախ նախադիտում",
    "restartMayBeRequired": "Որոշ փոփոխությունների համար կարող է անհրաժեշտ լինել կրկին բացել հավելվածը։",
    "translationCoverage": "Թարգմանության ծածկույթ",
    "incompleteTranslation": "Որոշ բաժիններ կարող են դեռ ամբողջությամբ թարգմանված չլինել։"
  },
  "auth": {
    "welcomeTitle": "Բարի գալուստ Sabi",
    "welcomeSubtitle": "Պրեմիում սուպեր հավելված հաղորդակցության, վճարումների, բանկային ծառայությունների, բիզնեսի և առօրյա ծառայությունների համար։",
    "getStarted": "Սկսել",
    "signIn": "Մուտք",
    "signUp": "Ստեղծել հաշիվ",
    "signOut": "Դուրս գալ",
    "logOut": "Դուրս գալ հաշվից",
    "phoneTitle": "Հեռախոսահամար",
    "phoneSubtitle": "Մուտքագրեք ձեր համարը՝ շարունակելու համար։",
    ...
    "verifyTitle": "Հաստատում",
    "verifySubtitle": "Մուտքագրեք այն կոդը, որը մենք ուղարկել ենք ձեր համարին։",
    "codePlaceholder": "Հաստատման կոդ",
    "resendCode": "Ուղարկել կոդը կրկին",
    "resendTimer": "Ավելի ուշ կկարողանաք նոր կոդ պահանջել",
    "continueSecurely": "Շարունակել անվտանգ",
    "privacyNote": "Մենք օգտագործում ենք ձեր տվյալները միայն հաստատման, հաշվի պաշտպանության և հավելվածի հիմնական ծառայությունների համար։",
    "termsNotice": "Շարունակելով՝ դուք համաձայնում եք Օգտագործման պայմաններին և Գաղտնիության քաղաքականությանը։",
    "forgotPassword": "Մոռացե՞լ եք գաղտնաբառը",
    "createPin": "Ստեղծել PIN",
    "confirmPin": "Հաստատել PIN",
    "enterPin": "Մուտքագրել PIN",
    "useBiometrics": "Օգտագործել կենսաչափական տվյալներ",
    "biometricPrompt": "Հաստատեք կենսաչափական տվյալներով",
    "sessionExpired": "Ձեր սեսիան ավարտվել է։ Խնդրում ենք կրկին մուտք գործել։",
    "accountType": "Հաշվի տեսակ",
    "personalAccount": "Անձնական հաշիվ",
    "businessAccount": "Բիզնես հաշիվ",
    "merchantAccount": "Մերչանտ հաշիվ",
    "chooseAccountType": "Ընտրեք հաշվի տեսակը"
  },
  "onboarding": {
    "title": "Այն ամենը, ինչ ձեզ պետք է, մեկ հավելվածում",
    "subtitle": "Զրուցեք, վճարեք, կառավարեք ձեր դրամապանակը, օգտագործեք AI գործիքներ, վարեք բիզնես և օգտվեք առօրյա ծառայություններից՝ մեկ վայրում։",
    ...
    "aiTitle": "AI ամենուր",
    "aiSubtitle": "Թարգմանեք չաթերն ու զանգերը, ստեղծեք խելացի պատասխաններ և ուժեղացրեք պրեմիում աշխատանքային հոսքերը։",
    "profileTitle": "Միասնական պրոֆիլ",
    "profileSubtitle": "Ձեր պրոֆիլը, հանրային բովանդակությունը, գաղտնիության կարգավորումները և պրեմիում ինքնությունը մեկ համակարգում։",
    "customizationTitle": "Անհատականացված գլխավոր էջ",
    "customizationSubtitle": "Վիջեթներ, դյուրանցումներ, մինի-հավելվածներ և արագ մուտք՝ ձեր կարիքներին համապատասխան։",
    "finishTitle": "Ամեն ինչ պատրաստ է",
    "finishSubtitle": "Կարգավորեք ձեր հաշիվը և սկսեք օգտագործել Sabi-ն։"
  },
  "permissions": {
    "title": "Թույլտվություններ",
    "subtitle": "Թույլ տվեք մուտքը՝ հավելվածից լավագույն փորձը ստանալու համար։",
    "cameraTitle": "Տեսախցիկ",
    "cameraSubtitle": "Լուսանկարեք, ձայնագրեք վիդեոհաղորդագրություններ և սկանավորեք QR կոդեր։",
    "microphoneTitle": "Միկրոֆոն",
    "microphoneSubtitle": "Ուղարկեք ձայնային հաղորդագրություններ և մասնակցեք ձայնային ու վիդեոզանգերի։",
    "photosTitle": "Լուսանկարներ",
    "photosSubtitle": "Ընտրեք մեդիա պատկերասրահից և կառավարեք պրոֆիլի բովանդակությունը։",
    "contactsTitle": "Կոնտակտներ",
    "contactsSubtitle": "Ավելի արագ գտեք մարդկանց և կիսվեք կոնտակտային քարտերով։",
    "locationTitle": "Տեղադրություն",
    "locationSubtitle": "Կիսվեք ուղիղ տեղադրությամբ, բացեք վայրերը և բարելավեք տեղական ծառայությունները։",
    "notificationsTitle": "Ծանուցումներ",
    "notificationsSubtitle": "Ստացեք ծանուցումներ հաղորդագրությունների, վճարումների և կարևոր թարմացումների մասին։",
    "storageTitle": "Ֆայլեր և պահեստավորում",
    "storageSubtitle": "Վերբեռնեք և բացեք փաստաթղթեր, ներբեռնումներ և կիսված մեդիա։",
    "allowCamera": "Թույլատրել տեսախցիկը",
    "allowMicrophone": "Թույլատրել միկրոֆոնը",
    "allowPhotos": "Թույլատրել լուսանկարները",
    "allowContacts": "Թույլատրել կոնտակտները",
    "allowLocation": "Թույլատրել տեղադրությունը",
    "allowNotifications": "Թույլատրել ծանուցումները",
    "allowStorage": "Թույլատրել ֆայլերն ու պահեստավորումը",
    "permissionDenied": "Թույլտվությունը մերժված է",
    "permissionRequired": "Այս թույլտվությունը անհրաժեշտ է ընտրված գործողության համար։",
  ...
  "search": {
    "title": "Որոնում",
    "placeholder": "Որոնեք մարդկանց, չաթեր, վճարումներ, ծառայություններ, բիզնեսներ կամ կարգավորումներ",
    "recentSearches": "Վերջին որոնումներ",
    "clearHistory": "Մաքրել որոնման պատմությունը",
    "topResults": "Լավագույն արդյունքներ",
    "people": "Մարդիկ",
    "chats": "Չաթեր",
  ...
  "home": {
    ...
    "trending": "Թրենդային",
    "marketOverview": "Շուկայի ընդհանուր տեսք",
    "quickAccess": "Արագ մուտք",
    "recentActivity": "Վերջին ակտիվություն",
    "continueUsing": "Շարունակել այնտեղից, որտեղ կանգ առաք",
    "manageLayout": "Կառավարել դասավորությունը",
    "addWidget": "Ավելացնել վիջեթ",
    "removeWidget": "Հեռացնել վիջեթը",
    "pinWidget": "Ամրացնել վիջեթը",
    "unpinWidget": "Ապամրացնել վիջեթը",
    "editMode": "Խմբագրման ռեժիմ",
    "personalize": "Անհատականացնել",
    "searchPlaceholder": "Որոնեք հավելվածներ, կոնտակտներ, բիզնեսներ կամ ծառայություններ",
    "noWidgets": "Դեռ վիջեթներ չեն ավելացվել",
    "noRecentActivity": "Դեռ վերջին ակտիվություն չկա",
    "discoverMore": "Բացահայտել ավելին",
    "homeFeed": "Գլխավոր հոսք",
    "recommendedServices": "Առաջարկվող ծառայություններ",
    "walletWidget": "Դրամապանակի վիջեթ",
    "messengerWidget": "Մեսենջերի վիջեթ",
    "businessWidget": "Բիզնեսի վիջեթ",
    "aiWidget": "AI վիջեթ",
    "premiumWidget": "Պրեմիում վիջեթ",
    "addShortcut": "Ավելացնել դյուրանցում",
    "removeShortcut": "Հեռացնել դյուրանցումը",
  ...
  "wallet": {
    ...
    "cashOut": "Կանխիկացնել",
    "topUp": "Լիցքավորել",
    "topUpByCard": "Լիցքավորել քարտով",
    "topUpByBank": "Լիցքավորել բանկով",
    "exchange": "Փոխանակում",
    "convert": "Փոխարկել",
    "details": "Մանրամասներ",
    ...
    "linkBankAccount": "Կապել բանկային հաշիվը",
    "bindCard": "Կապել քարտը",
    "cardHolder": "Քարտատեր",
    ...
    "transferByPhone": "Փոխանցում հեռախոսահամարով",
    "transferByCard": "Փոխանցում քարտով",
    ...
    "pending": "Սպասման մեջ",
    "failed": "Չհաջողվեց",
    "noTransactions": "Գործարքներ դեռ չկան",
    "noCards": "Քարտեր դեռ չեն կապվել",
    "noBankAccounts": "Բանկային հաշիվներ դեռ չեն կապվել",
    "primaryCard": "Հիմնական քարտ",
    "primaryAccount": "Հիմնական հաշիվ",
    "setPrimary": "Սահմանել որպես հիմնական",
    "cardSecurity": "Քարտի անվտանգություն",
    "spendingLimits": "Ծախսի սահմանաչափեր",
    "withdrawalLimits": "Կանխիկացման սահմանաչափեր",
    "transferLimits": "Փոխանցման սահմանաչափեր",
    "dailyLimit": "Օրական սահմանաչափ",
    "monthlyLimit": "Ամսական սահմանաչափ",
    "viewAllTransactions": "Տեսնել բոլոր գործարքները",
    "feesAndLimits": "Միջնորդավճարներ և սահմանաչափեր",
    "walletSettings": "Դրամապանակի կարգավորումներ",
    "paymentMethods": "Վճարման եղանակներ",
    "balanceHidden": "Մնացորդը թաքցված է",
    "hideBalance": "Թաքցնել մնացորդը",
    "showBalance": "Ցույց տալ մնացորդը",
    "walletBlocked": "Դրամապանակը արգելափակված է",
    "walletFrozen": "Դրամապանակը սառեցված է",
    "walletActive": "Դրամապանակը ակտիվ է",
    "confirmTransfer": "Հաստատել փոխանցումը",
    "reviewPayment": "Վերանայել վճարումը",
    "securePayment": "Անվտանգ վճարում",
    "tapToPay": "Հպեք վճարելու համար",
    "payNow": "Վճարել հիմա",
    "notEnoughFunds": "Բավարար միջոցներ չկան",
    "addFunds": "Ավելացնել միջոցներ",
    "receiveFromContacts": "Ստանալ կոնտակտներից",
    "sendToContacts": "Ուղարկել կոնտակտներին",
    "cardAlreadyLinked": "Այս քարտն արդեն կապվել է",
    "accountAlreadyLinked": "Այս բանկային հաշիվն արդեն կապվել է",
    "cardLinkSuccess": "Քարտը հաջողությամբ կապվեց",
    "accountLinkSuccess": "Բանկային հաշիվը հաջողությամբ կապվեց",
    "exchangeRate": "Փոխարժեք",
    "estimatedArrival": "Մոտավոր հասնելու ժամանակ",
    "settlementBalance": "Հաշվանցման մնացորդ",
    "payoutBalance": "Վճարման մնացորդ",
    "reservedBalance": "Պահուստային մնացորդ",
    "heldBalance": "Պահված մնացորդ",
  ...
  "walletCards": {
    ...
    "scanCard": "Սկանավորել քարտը",
    "manualEntry": "Քարտը մուտքագրել ձեռքով",
    ...
    "freezeCard": "Սառեցնել քարտը",
    "unfreezeCard": "Ապասառեցնել քարտը",
    "replaceCard": "Փոխարինել քարտը",
    "reissueCard": "Վերաթողարկել քարտը",
    "linkedCards": "Կապակցված քարտեր",
    "cardInfo": "Քարտի տվյալներ",
    "network": "Վճարային ցանց",
    "issuer": "Թողարկող",
    "issuerCountry": "Թողարկողի երկիր",
    "domesticRouting": "Ներքին ուղղորդում",
    "internationalRouting": "Միջազգային ուղղորդում",
    "supportsOnlinePayments": "Աջակցում է առցանց վճարումները",
    "supportsTransfers": "Աջակցում է փոխանցումները",
    "cardManagement": "Քարտի կառավարում",
    "cardSecurityTips": "Քարտի անվտանգության խորհուրդներ",
    "spendingControl": "Ծախսի վերահսկում",
    "internetPayments": "Ինտերնետ վճարումներ",
    "contactlessPayments": "Անհպում վճարումներ",
    "cardStatus": "Քարտի կարգավիճակ",
    "cashWithdrawal": "Կանխիկի ելք",
    "atmWithdrawal": "Բանկոմատից ելք",
    "cardToCardTransfer": "Քարտից քարտ փոխանցում",
    "tokenizedPayments": "Թոքենացված վճարումներ",
    "cardLimitResetDate": "Քարտի սահմանաչափի վերակայման ամսաթիվ",
    "verificationMode": "Ստուգման ռեժիմ"
  },
  "bankAccounts": {
    "title": "Բանկային հաշիվներ",
    "subtitle": "Կառավարեք կապակցված բանկային հաշիվները, քաղվածքները և բանկային տվյալները։",
    "accountOverview": "Հաշվի ընդհանուր տեսք",
    "addBankAccount": "Ավելացնել բանկային հաշիվ",
    "linkBankAccount": "Կապել բանկային հաշիվը",
    "verifyBankAccount": "Ստուգել բանկային հաշիվը",
    "removeBankAccount": "Հեռացնել բանկային հաշիվը",
    "bankName": "Բանկի անուն",
    "branchName": "Մասնաճյուղի անուն",
    "accountName": "Հաշվի անուն",
    "accountType": "Հաշվի տեսակ",
    "checkingAccount": "Ընթացիկ հաշիվ",
    "savingsAccount": "Խնայողական հաշիվ",
    "settlementAccount": "Հաշվանցման հաշիվ",
    "currentAccount": "Ընթացիկ հաշիվ",
    "accountHolder": "Հաշվետեր",
    "beneficiaryName": "Շահառուի անուն",
    ...
    "bankCode": "Բանկի կոդ",
    "branchCode": "Մասնաճյուղի կոդ",
    "currency": "Հաշվի արժույթ",
    "statementName": "Քաղվածքի անուն",
    "openingBalance": "Սկզբնական մնացորդ",
    "closingBalance": "Վերջնական մնացորդ",
    "availableBalance": "Հասանելի մնացորդ",
    "ledgerBalance": "Գրանցամատյանի մնացորդ",
    "reservedFunds": "Պահուստային միջոցներ",
    "heldFunds": "Պահված միջոցներ",
    "primaryAccount": "Հիմնական հաշիվ",
    "setAsPrimary": "Դարձնել հիմնական",
    "noLinkedAccounts": "Կապակցված բանկային հաշիվներ դեռ չկան",
    "linkSuccess": "Բանկային հաշիվը հաջողությամբ կապվեց",
    "verificationPending": "Բանկային հաշվի ստուգումը սպասման մեջ է",
    "verificationComplete": "Բանկային հաշիվը ստուգված է"
  },
  "bankTransfers": {
    "title": "Բանկային փոխանցումներ",
    "subtitle": "Ուղարկեք ներքին և միջազգային փոխանցումներ ամբողջական բանկային տվյալներով։",
    "newTransfer": "Նոր փոխանցում",
    "transferDetails": "Փոխանցման մանրամասներ",
    "transferType": "Փոխանցման տեսակ",
    "domesticTransfer": "Ներքին փոխանցում",
    "internationalTransfer": "Միջազգային փոխանցում",
    "swiftTransfer": "SWIFT փոխանցում",
    "wireTransfer": "Wire փոխանցում",
    ...
    "transferTo": "Փոխանցել այստեղ",
    "senderAccount": "Ուղարկողի հաշիվ",
    "recipientAccount": "Ստացողի հաշիվ",
    "recipientCard": "Ստացողի քարտ",
    "beneficiary": "Շահառու",
    "beneficiaryName": "Շահառուի անուն",
    "beneficiaryBank": "Շահառուի բանկ",
    ...
    "correspondentFee": "Թղթակցային բանկի միջնորդավճար",
    "intermediaryFee": "Միջնորդ բանկի միջնորդավճար",
    "exchangeRate": "Փոխարժեք",
    "totalDebit": "Ընդհանուր գանձում",
    "purposeOfPayment": "Վճարման նպատակ",
    "paymentReference": "Վճարման հղում",
    "senderToReceiverInfo": "Տեղեկություն ուղարկողից ստացողին",
    "transferMemo": "Փոխանցման նշում",
    "executionDate": "Կատարման ամսաթիվ",
    "estimatedArrival": "Մոտավոր հասնելու ժամանակ",
    "transferPriority": "Փոխանցման առաջնահերթություն",
    "standardPriority": "Ստանդարտ",
    "urgentPriority": "Շտապ",
    "reviewTransfer": "Վերանայել փոխանցումը",
    "confirmTransfer": "Հաստատել փոխանցումը",
    "saveRecipient": "Պահպանել ստացողին",
    "savedRecipients": "Պահված ստացողներ",
    "repeatTransfer": "Կրկնել փոխանցումը",
    "cancelTransfer": "Չեղարկել փոխանցումը",
  ...
  "walletCoin": {
    ...
    "startDeposit": "Սկսել ավանդը",
    "closeDeposit": "Փակել ավանդը",
    "depositRules": "Ավանդի կանոններ",
    "minimumTerm": "Նվազագույն ժամկետ",
  ...
  "walletBusiness": {
    "title": "Բիզնես դրամապանակ",
    "subtitle": "Կառավարեք բիզնես մնացորդները, վճարումները, հաշիվները և թիմային գործառույթները։",
    "mainBalance": "Հիմնական մնացորդ",
    "operatingBalance": "Գործառնական մնացորդ",
    "settlementBalance": "Հաշվանցման մնացորդ",
    "availableForPayout": "Հասանելի է վճարման համար",
    "pendingSettlement": "Սպասվող հաշվանցում",
    "reservedBalance": "Պահուստային մնացորդ",
    "heldFunds": "Պահված միջոցներ",
    "payouts": "Վճարումներ",
    "payoutHistory": "Վճարումների պատմություն",
    "payoutSchedule": "Վճարումների ժամանակացույց",
    "sameDayPayout": "Նույն օրվա վճարում",
    "nextDayPayout": "Հաջորդ օրվա վճարում",
    "issueInvoice": "Ստեղծել հաշիվ",
    "collectPayment": "Հավաքել վճարում",
    "staffAccess": "Աշխատակազմի հասանելիություն",
    "teamPermissions": "Թիմի թույլտվություններ",
    "businessTransfers": "Բիզնես փոխանցումներ",
    "salaryPayments": "Աշխատավարձի վճարումներ",
    "payroll": "Աշխատավարձային ցուցակ",
    "massPayouts": "Զանգվածային վճարումներ",
    "expenseControl": "Ծախսերի վերահսկում",
    "cashFlow": "Դրամական հոսք",
    "receivables": "Ստացվելիք գումարներ",
    "payables": "Վճարվելիք գումարներ",
    "treasury": "Գանձապետարան",
    "taxReports": "Հարկային հաշվետվություններ",
    "financeReports": "Ֆինանսական հաշվետվություններ",
    "exportReports": "Արտահանել հաշվետվությունները",
    "businessCard": "Բիզնես քարտ",
    "addBusinessCard": "Ավելացնել բիզնես քարտ",
    "bankReconciliation": "Բանկային հաշտեցում",
    "reconciliationStatus": "Հաշտեցման կարգավիճակ",
    "unmatchedTransactions": "Չհամընկնող գործարքներ",
    "noBusinessWallet": "Բիզնես դրամապանակը դեռ միացված չէ"
  },
  "walletMerchant": {
    "title": "Մերչանտ դրամապանակ",
    "subtitle": "Ստացեք մերչանտ վճարումներ, կառավարեք հաշվանցումները և հետևեք վաճառքներին։",
    "merchantBalance": "Մերչանտ մնացորդ",
    "salesToday": "Այսօրվա վաճառքներ",
    "salesThisWeek": "Այս շաբաթվա վաճառքներ",
    "salesThisMonth": "Այս ամսվա վաճառքներ",
    "grossSales": "Համախառն վաճառք",
    "netSales": "Մաքուր վաճառք",
    "refunds": "Վերադարձներ",
    "refundRate": "Վերադարձի մակարդակ",
    "chargebacks": "Չարգբեքեր",
    "chargebackRate": "Չարգբեքի մակարդակ",
    "disputes": "Վեճեր",
    "paymentAcceptance": "Վճարումների ընդունում",
    "terminalPayments": "Տերմինալային վճարումներ",
    "qrPayments": "QR վճարումներ",
    "onlinePayments": "Առցանց վճարումներ",
    "invoicePayments": "Հաշիվ-ապրանքագրերի վճարումներ",
    "acquiring": "Էքվայրինգ",
    "acquiringRate": "Էքվայրինգի դրույք",
    "settlementSchedule": "Հաշվանցման ժամանակացույց",
    "settlementCycle": "Հաշվանցման ցիկլ",
    "settlementCutoffTime": "Հաշվանցման վերջին ժամ",
    "autoSettlement": "Ավտոմատ հաշվանցում",
    "manualSettlement": "Ձեռքով հաշվանցում",
    "reserveHold": "Պահուստի պահում",
    "rollingReserve": "Պտտվող պահուստ",
    "reserveReleaseDate": "Պահուստի ազատման ամսաթիվ",
    "payoutToWallet": "Վճարել դրամապանակին",
    "payoutToBank": "Վճարել բանկին",
    "merchantFee": "Մերչանտ միջնորդավճար",
    "settlementReport": "Հաշվանցման հաշվետվություն",
    "reconciliationReport": "Հաշտեցման հաշվետվություն",
    "capturedPayments": "Գանձված վճարումներ",
    "authorizedPayments": "Լիազորված վճարումներ",
    "reversedPayments": "Հետադարձված վճարումներ",
    "noMerchantWallet": "Մերչանտ դրամապանակը դեռ միացված չէ"
  },
  "walletTransactions": {
    "title": "Գործարքներ",
    "allTransactions": "Բոլոր գործարքները",
    "filterTransactions": "Ֆիլտրել գործարքները",
    "transactionType": "Գործարքի տեսակ",
    "transactionStatus": "Գործարքի կարգավիճակ",
    "dateRange": "Ամսաթվերի միջակայք",
    "amountRange": "Գումարի միջակայք",
    "payment": "Վճարում",
    "transfer": "Փոխանցում",
    "topUp": "Լիցքավորում",
    ...
    "reference": "Հղում",
    "receipt": "Կտրոն",
    "receiptNumber": "Կտրոնի համար",
    "authorizationCode": "Ավտորիզացման կոդ",
    "merchantReference": "Մերչանտ հղում",
    "acquirerReference": "Էքվայրերի հղում",
    "downloadReceipt": "Ներբեռնել կտրոնը",
    "shareReceipt": "Կիսվել կտրոնով",
    "repeatTransfer": "Կրկնել փոխանցումը",
    "reportIssue": "Հայտնել խնդրի մասին",
    "disputePayment": "Վիճարկել վճարումը",
    "statementEntry": "Քաղվածքի գրառում",
    "settlement": "Հաշվանցում",
    "merchantSale": "Մերչանտ վաճառք",
    "payout": "Վճարում",
    "commission": "Հանձնաժողով",
    "serviceCharge": "Ծառայության վճար",
    "preauthorization": "Նախնական թույլտվություն",
    "capture": "Գանձում",
    "reversal": "Հետադարձում",
    "settlementFee": "Հաշվանցման միջնորդավճար",
    "withholding": "Պահում",
    "noFilteredResults": "Չկան գործարքներ, որոնք համապատասխանում են ընտրված ֆիլտրերին"
  },
  "statements": {
    "title": "Քաղվածքներ",
    "subtitle": "Ստեղծեք, ներբեռնեք և արտահանեք հաշվի քաղվածքներ։",
    "accountStatement": "Հաշվի քաղվածք",
    "cardStatement": "Քարտի քաղվածք",
    "businessStatement": "Բիզնես քաղվածք",
    "merchantStatement": "Մերչանտ քաղվածք",
    "monthlyStatement": "Ամսական քաղվածք",
    "customStatement": "Անհատական քաղվածք",
    "statementPeriod": "Քաղվածքի ժամանակահատված",
    ...
    "openingBalance": "Սկզբնական մնացորդ",
    "totalCredits": "Ընդհանուր մուտքեր",
    "totalDebits": "Ընդհանուր ելքեր",
    "closingBalance": "Վերջնական մնացորդ",
    "statementReady": "Քաղվածքը պատրաստ է",
    "noStatements": "Քաղվածքներ դեռ չկան"
  },
  "compliance": {
    ...
    "proofOfAddress": "Հասցեի ապացույց",
    "businessDocuments": "Բիզնես փաստաթղթեր",
    "merchantDocuments": "Մերչանտ փաստաթղթեր",
    "complianceStatus": "Համապատասխանության կարգավիճակ",
    "verificationLevel": "Ստուգման մակարդակ",
    "underReview": "Վերանայման տակ",
    "additionalDocumentsRequired": "Լրացուցիչ փաստաթղթեր են պահանջվում",
    "submitDocuments": "Ներկայացնել փաստաթղթեր",
    "reviewDocuments": "Վերանայել փաստաթղթերը",
    "complianceApproved": "Համապատասխանությունը հաստատված է",
    "complianceRejected": "Համապատասխանությունը մերժված է",
    "transactionMonitoring": "Գործարքների մոնիթորինգ",
  ...
  "qr": {
    ...
    "myQr": "Իմ QR",
    "payByQr": "Վճարել QR-ով",
    "receiveByQr": "Ստանալ QR-ով",
    "shareQr": "Կիսվել QR-ով",
    "saveQr": "Պահպանել QR",
    "businessQr": "Բիզնես QR",
    "merchantQr": "Մերչանտ QR",
    "staticQr": "Ստատիկ QR",
    "dynamicQr": "Դինամիկ QR",
    "qrExpired": "QR կոդի ժամկետը լրացել է",
    "qrInvalid": "Անվավեր QR կոդ",
    "qrPermissionNeeded": "QR կոդերը սկանավորելու համար անհրաժեշտ է տեսախցիկի թույլտվություն։"
  },
  "messenger": {
    "title": "Մեսենջեր",
    "chats": "Չաթեր",
    ...
    "channels": "Ալիքներ",
    "bots": "Բոտեր",
    "businessInbox": "Բիզնես մուտքային արկղ",
    "newChat": "Նոր չաթ",
    "newGroup": "Նոր խումբ",
    "newChannel": "Նոր ալիք",
    "message": "Հաղորդագրություն",
    ...
    "sticker": "Սթիքեր",
    "premiumSticker": "Պրեմիում սթիքեր",
    "animated": "Անիմացված",
    "voiceMessage": "Ձայնային հաղորդագրություն",
    "videoMessage": "Վիդեո հաղորդագրություն",
    "record": "Ձայնագրել",
    "releaseToSend": "Բաց թողեք՝ ուղարկելու համար",
    "holdToRecord": "Պահեք՝ ձայնագրելու համար",
    "swipeToCancel": "Սահեցրեք՝ չեղարկելու համար",
    "reply": "Պատասխանել",
    "forward": "Փոխանցել",
    "copyText": "Պատճենել տեքստը",
    "editMessage": "Խմբագրել հաղորդագրությունը",
    "deleteMessage": "Ջնջել հաղորդագրությունը",
    "deleteForMe": "Ջնջել միայն ինձ համար",
    "deleteForEveryone": "Ջնջել բոլորի համար",
    "selectMessages": "Ընտրել հաղորդագրություններ",
    "reactions": "Ռեակցիաներ",
    "quickReactions": "Արագ ռեակցիաներ",
    "muteChat": "Լռեցնել չաթը",
    "unmuteChat": "Միացնել չաթի ձայնը",
    "pinChat": "Ամրացնել չաթը",
    "unpinChat": "Ապամրացնել չաթը",
    "archiveChat": "Արխիվացնել չաթը",
    "unarchiveChat": "Հանել արխիվից",
    "markAsRead": "Նշել որպես ընթերցված",
    "markAsUnread": "Նշել որպես չընթերցված",
    "chatInfo": "Չաթի մասին",
    "online": "Առցանց",
    "lastSeen": "Վերջին անգամ առցանց",
    "noChats": "Չաթեր դեռ չկան",
    "searchChats": "Որոնել չաթերում",
    "startConversation": "Սկսել զրույց",
    "audioCall": "Ձայնային զանգ",
    "videoCall": "Վիդեոզանգ",
    ...
    "sharedLinks": "Կիսված հղումներ",
    "unreadMessages": "Չընթերցված հաղորդագրություններ",
    "messageEdited": "Խմբագրված է",
    "messageDeleted": "Հաղորդագրությունը ջնջված է",
    "failedToSend": "Չհաջողվեց ուղարկել",
    "tapToRetry": "Հպեք՝ կրկին փորձելու համար",
    "connecting": "Միացվում է...",
    "encryptedChat": "Կոդավորված չաթ",
    "businessChat": "Բիզնես չաթ",
    "merchantChat": "Մերչանտ չաթ",
    "aiReply": "AI պատասխան",
    "translateChat": "Թարգմանել չաթը",
    ...
    "chat": {
      ...
      "readOnlySubtitle": "Sending messages is disabled here. Open channel info for details.",
      "mediaLabel": "Media",
      "mediaTitle": "Media",
      ...
      "mutedDisabled": "Notifications enabled",
  ...
  "chatRoom": {
    ...
    "selectedMessages": "Ընտրված հաղորդագրություններ",
    "clearSelection": "Մաքրել ընտրությունը",
    "copySelection": "Պատճենել ընտրությունը",
    "forwardSelection": "Փոխանցել ընտրությունը",
    "deleteSelection": "Ջնջել ընտրությունը",
    "mediaActions": "Մեդիայի գործողություններ",
    "audioMessage": "Ձայնային հաղորդագրություն",
    "videoMessage": "Վիդեո հաղորդագրություն",
    ...
    "openCamera": "Բացել տեսախցիկը",
    "openDocuments": "Բացել փաստաթղթերը",
    "openLocation": "Բացել տեղադրությունը",
    "shareContact": "Կիսվել կոնտակտով",
    "sendPhoto": "Ուղարկել լուսանկար",
    "sendVideo": "Ուղարկել տեսանյութ",
    "sendDocument": "Ուղարկել փաստաթուղթ",
    "sendLocation": "Ուղարկել տեղադրություն",
    "sendContact": "Ուղարկել կոնտակտ",
    "sendAnimated": "Ուղարկել անիմացիա",
    "sendSticker": "Ուղարկել սթիքեր",
    "sendGift": "Ուղարկել նվեր",
    "sendPremiumSticker": "Ուղարկել պրեմիում սթիքեր",
    "openFullscreen": "Բացել ամբողջ էկրանով",
    "saveToDevice": "Պահպանել սարքում",
    "messageInfo": "Հաղորդագրության մասին",
    "showReactions": "Ցույց տալ ռեակցիաները",
    "addReaction": "Ավելացնել ռեակցիա",
    "removeReaction": "Հեռացնել ռեակցիան",
    "jumpToLatest": "Անցնել վերջինին",
    "silentMessage": "Լուռ հաղորդագրություն",
    "scheduleMessage": "Պլանավորել հաղորդագրությունը",
    "aiTools": "AI գործիքներ",
    "translateThisMessage": "Թարգմանել այս հաղորդագրությունը",
    ...
    "mutedEnabled": "Notifications muted",
    "mutedDisabled": "Notifications yoqildi",
  ...
  "chatPartner": {
    ...
    "media": "Մեդիա",
    "gifts": "Նվերներ",
    "premiumGifts": "Պրեմիում նվերներ",
    "publicInfo": "Հանրային տեղեկատվություն",
    "sharedGroups": "Ընդհանուր խմբեր",
    "sharedMedia": "Կիսված մեդիա",
    "reportUser": "Հաղորդել օգտատիրոջ մասին",
    "blockUser": "Արգելափակել օգտատիրոջը",
    "unblockUser": "Ապաարգելափակել օգտատիրոջը",
    "restrictUser": "Սահմանափակել օգտատիրոջը",
    "clearChat": "Մաքրել չաթը",
    "deleteChat": "Ջնջել չաթը",
    "notifications": "Ծանուցումներ",
    "wallpaper": "Պաստառ",
    "customWallpaper": "Անհատական պաստառ",
    "setChatWallpaper": "Սահմանել չաթի պաստառ",
    "removeChatWallpaper": "Հեռացնել չաթի պաստառը",
    "partnerActions": "Գործողություններ",
    "profileBadges": "Պրոֆիլի նշաններ",
    "premiumStatus": "Պրեմիում կարգավիճակ",
    "businessStatus": "Բիզնես կարգավիճակ",
    "merchantStatus": "Մերչանտ կարգավիճակ"
  },
  "stickers": {
    "title": "Սթիքերներ",
    "recent": "Վերջին",
    "favorite": "Ընտրյալ",
    "trending": "Թրենդային",
    "packs": "Սթիքերների փաթեթներ",
    "premiumPacks": "Պրեմիում փաթեթներ",
    "installPack": "Տեղադրել փաթեթը",
    ...
    "aiSticker": "AI սթիքեր",
    "premiumStickerLibrary": "Պրեմիում սթիքերների գրադարան"
  },
  "gifts": {
    "title": "Նվերներ",
    "sendGift": "Ուղարկել նվեր",
    "receivedGifts": "Ստացված նվերներ",
    "sentGifts": "Ուղարկված նվերներ",
    "giftHistory": "Նվերների պատմություն",
    "inventory": "Պաշար",
    "noGifts": "Նվերներ դեռ չկան",
    "basicGift": "Հիմնական նվեր",
    "premiumGift": "Պրեմիում նվեր",
    "ultraGift": "Ուլտրա նվեր",
    "seasonalGifts": "Սեզոնային նվերներ",
    "eventGifts": "Միջոցառման նվերներ",
    "giftDetails": "Նվերի մանրամասներ",
    "giftPlayback": "Նվերի ցուցադրում",
    "replayGift": "Կրկին ցուցադրել նվերը",
    ...
    "spin": "Պտտել",
    "costPerSpin": "Մեկ պտույտի արժեքը",
    "premiumPlayback": "Պրեմիում ցուցադրում",
    "overChatPlayback": "Ցուցադրում չաթի վրա"
  },
  "payments": {
    "title": "Վճարումներ",
    "sendPayment": "Ուղարկել վճարում",
    "requestPayment": "Հարցում վճարման համար",
    "payContact": "Վճարել կոնտակտին",
    "payMerchant": "Վճարել մերչանտին",
    "merchantPayment": "Մերչանտ վճարում",
    "payInvoice": "Վճարել հաշիվ-ապրանքագիրը",
    "invoice": "Հաշիվ-ապրանքագիր",
    "invoiceNumber": "Հաշիվ-ապրանքագրի համար",
    "paymentLink": "Վճարման հղում",
    "paymentMethod": "Վճարման եղանակ",
    "choosePaymentMethod": "Ընտրեք վճարման եղանակը",
    "reviewAndConfirm": "Ստուգել և հաստատել",
    "paymentConfirmed": "Վճարումը հաստատվել է",
    "paymentFailed": "Վճարումը ձախողվել է",
    "paymentPending": "Վճարումը սպասման մեջ է",
    "paymentCancelled": "Վճարումը չեղարկվել է",
    "requestSent": "Հարցումն ուղարկվել է",
    "requestPaid": "Հարցումը վճարվել է",
    "splitBill": "Կիսել հաշիվը",
    "servicePayment": "Ծառայության վճարում",
    ...
    "partialCapture": "Մասնակի գանձում",
    "voidAuthorization": "Չեղարկել թույլտվությունը",
    "refundPayment": "Վերադարձնել վճարումը",
    "partialRefund": "Մասնակի վերադարձ",
    "chargeback": "Չարգբեք",
    "dispute": "Վեճ",
    "settlement": "Հաշվանցում",
    "settlementDelay": "Հաշվանցման ուշացում",
    "merchantSettlement": "Մերչանտ հաշվանցում",
    "acquiringFee": "Էքվայրինգի միջնորդավճար",
    "serviceFee": "Ծառայության վճար",
    "processingFee": "Մշակման վճար",
    "platformFee": "Հարթակի վճար",
    "payout": "Վճարում"
  },
  "contacts": {
    "title": "Կոնտակտներ",
    "searchContacts": "Որոնել կոնտակտներ",
    "inviteContacts": "Հրավիրել կոնտակտներին",
    "syncContacts": "Համաժամացնել կոնտակտները",
    "syncedContacts": "Համաժամացված կոնտակտներ",
    "noContacts": "Կոնտակտներ չեն գտնվել",
    "shareProfile": "Կիսվել պրոֆիլով",
    "shareContactCard": "Կիսվել կոնտակտային քարտով",
    "addToContacts": "Ավելացնել կոնտակտներին",
    "removeFromContacts": "Հեռացնել կոնտակտներից",
    "blockedContacts": "Արգելափակված կոնտակտներ",
    "businessContacts": "Բիզնես կոնտակտներ",
    "merchantContacts": "Մերչանտ կոնտակտներ"
  },
  "profile": {
    "completeScreen": {
      "badge": "Profile setup",
    ...
    "qrSettings": "QR կարգավորումներ",
    "colors": "Գույներ",
    "language": "Լեզու",
    "publicPhotos": "Հանրային լուսանկարներ",
    "privatePhotos": "Մասնավոր լուսանկարներ",
    "selectedForPublic": "Ընտրված է հանրային ցուցադրման համար",
    "markAsPublic": "Դարձնել հանրային",
    "removeFromPublic": "Հեռացնել հանրայինից",
    "saveChanges": "Պահպանել փոփոխությունները",
    "changePhoto": "Փոխել լուսանկարը",
    "removePhoto": "Հեռացնել լուսանկարը",
    "addPhoto": "Ավելացնել լուսանկար",
    "addVideo": "Ավելացնել տեսանյութ",
    "editBio": "Խմբագրել կենսագրությունը",
    ...
    "managePublicContent": "Կառավարել հանրային բովանդակությունը",
    "noPublicPhotos": "Հանրային լուսանկարներ դեռ չկան",
    "noPrivatePhotos": "Մասնավոր լուսանկարներ դեռ չկան",
    "noVideos": "Տեսանյութեր դեռ չկան",
    "badges": "Նշաններ",
    "verificationBadge": "Ստուգման նշան",
  ...
  "premium": {
    ...
    "premiumStickers": "Պրեմիում սթիքերներ",
    "enhancedProfile": "Բարելավված պրոֆիլ",
    ...
    "aiRewrite": "AI վերաշարադրում",
    "prioritySupport": "Առաջնահերթ աջակցություն",
    "advancedBusinessTools": "Առաջադեմ բիզնես գործիքներ",
    "advancedMerchantTools": "Առաջադեմ մերչանտ գործիքներ",
    "premiumBankingTools": "Պրեմիում բանկային գործիքներ"
  },
  "ai": {
    "title": "AI",
    "subtitle": "Պրեմիում AI գործիքներ մեսենջերում, պրոֆիլում, բիզնեսում և աջակցությունում։",
    "aiAssistant": "AI օգնական",
    "aiTranslator": "AI թարգմանիչ",
    "aiWriter": "AI գրող",
    "aiReply": "AI պատասխան",
    "aiRewrite": "AI վերաշարադրում",
    "aiSummary": "AI ամփոփում",
    "aiProfileAssistant": "AI պրոֆիլի օգնական",
    "aiBusinessAssistant": "AI բիզնես օգնական",
    "aiMerchantAssistant": "AI մերչանտ օգնական",
    "chatTranslation": "Չաթի թարգմանություն",
    "callTranslation": "Զանգի թարգմանություն",
    "voiceTranslation": "Ձայնի թարգմանություն",
    "videoTranslation": "Տեսանյութի թարգմանություն",
    "liveSubtitles": "Ուղիղ ենթագրեր",
    "detectLanguage": "Լեզվի ավտոմատ հայտնաբերում",
    "originalText": "Բնօրինակ տեքստ",
    "translatedText": "Թարգմանված տեքստ",
    "translateIncomingOnly": "Թարգմանել միայն մուտքայինները",
    "translateBothSides": "Թարգմանել երկու կողմերին էլ",
    "translationHistory": "Թարգմանությունների պատմություն",
    "autoTranslate": "Ավտոմատ թարգմանություն",
    "disableAutoTranslate": "Անջատել ավտոմատ թարգմանությունը",
    "smartSuggestions": "Խելացի առաջարկներ",
    "toneFormal": "Պաշտոնական ոճ",
    "toneFriendly": "Ընկերական ոճ",
    "toneBusiness": "Բիզնես ոճ",
    "generateReply": "Ստեղծել պատասխան",
  ...
  "businessAccount": {
    "title": "Բիզնես հաշիվ",
    "subtitle": "Կառավարեք ձեր բիզնեսը առաջադեմ հաղորդակցությամբ, վճարումներով և վերահսկմամբ։",
    "createBusinessAccount": "Ստեղծել բիզնես հաշիվ",
    "switchToBusiness": "Անցնել բիզնեսի",
    "businessProfile": "Բիզնես պրոֆիլ",
    "companyName": "Ընկերության անուն",
    "brandName": "Բրենդի անուն",
    "legalName": "Իրավաբանական անուն",
    "businessCategory": "Բիզնես կատեգորիա",
    "registrationNumber": "Գրանցման համար",
    "taxId": "Հարկային համար",
    "businessAddress": "Բիզնեսի հասցե",
    "workingHours": "Աշխատանքային ժամեր",
    "businessDescription": "Բիզնեսի նկարագրություն",
    "businessInbox": "Բիզնես մուտքային արկղ",
    "customerMessages": "Հաճախորդների հաղորդագրություններ",
    "catalog": "Կատալոգ",
    "services": "Ծառայություններ",
    "invoices": "Հաշիվ-ապրանքագրեր",
    "staff": "Աշխատակազմ",
    "staffRoles": "Աշխատակազմի դերեր",
    ...
    "awayMessage": "Բացակայության հաղորդագրություն",
    "teamAccess": "Թիմի հասանելիություն",
    "performance": "Արդյունավետություն",
    "revenue": "Եկամուտ",
    "customerGrowth": "Հաճախորդների աճ",
    "conversionRate": "Փոխակերպման մակարդակ",
    "businessVerification": "Բիզնեսի ստուգում",
    "verifyBusiness": "Ստուգել բիզնեսը",
    "verifiedBusiness": "Ստուգված բիզնես",
    "businessSettings": "Բիզնեսի կարգավորումներ",
    "treasuryControls": "Գանձապետարանի վերահսկումներ",
    "bankingAccess": "Բանկային հասանելիություն"
  },
  "merchantAccount": {
    "title": "Մերչանտ հաշիվ",
    "subtitle": "Ստացեք վճարումներ, կառավարեք վաճառքները և վարեք մերչանտ աշխատանքային հոսքերը։",
    "createMerchantAccount": "Ստեղծել մերչանտ հաշիվ",
    "merchantProfile": "Մերչանտ պրոֆիլ",
    "storeName": "Խանութի անուն",
    "merchantCategory": "Մերչանտ կատեգորիա",
    "merchantId": "Մերչանտ ID",
    "sellerDashboard": "Վաճառողի վահանակ",
    "sales": "Վաճառքներ",
    "orders": "Պատվերներ",
    "products": "Ապրանքներ",
    "stock": "Պաշար",
    ...
    "staffAccess": "Աշխատակազմի հասանելիություն",
    "merchantAnalytics": "Մերչանտ վերլուծություններ",
    "topProducts": "Լավագույն ապրանքներ",
    "averageOrderValue": "Պատվերի միջին արժեք",
    "paymentSuccessRate": "Վճարումների հաջողության մակարդակ",
    "merchantVerification": "Մերչանտի ստուգում",
    "verifyMerchant": "Ստուգել մերչանտին",
    "verifiedMerchant": "Ստուգված մերչանտ",
    "merchantSettings": "Մերչանտի կարգավորումներ",
    "settlementPreferences": "Հաշվանցման նախապատվություններ",
    "acquiringControls": "Էքվայրինգի վերահսկումներ"
  },
  "stream": {
    "title": "Սթրիմ",
    "liveNow": "Ուղիղ հիմա",
    "upcoming": "Առաջիկա",
    "ended": "Ավարտված",
    "startStream": "Սկսել սթրիմը",
    "scheduleStream": "Պլանավորել սթրիմը",
    "streamSettings": "Սթրիմի կարգավորումներ",
    "viewers": "Դիտողներ",
    "streamChat": "Սթրիմի չաթ",
    "streamGifts": "Սթրիմի նվերներ",
  ...
  "marketplace": {
    ...
    "removeFromCart": "Հեռացնել զամբյուղից",
    "productDetails": "Ապրանքի մանրամասներ",
    "sellerInfo": "Վաճառողի տվյալներ",
    "delivery": "Առաքում",
    "pickup": "Ինքնառաքում",
  ...
  "taxi": {
    "title": "Տաքսի",
    "whereTo": "Ու՞ր եք գնում",
    "pickupPoint": "Վերցնելու կետ",
    "destination": "Նպատակակետ",
    "chooseRide": "Ընտրեք ուղևորություն",
    "confirmRide": "Հաստատել ուղևորությունը",
    "driverArriving": "Վարորդը մոտենում է",
    "rideStarted": "Ուղևորությունը սկսվել է",
    "rideCompleted": "Ուղևորությունն ավարտված է",
    "rideCancelled": "Ուղևորությունը չեղարկվել է",
    "contactDriver": "Կապվել վարորդի հետ",
    "shareTrip": "Կիսվել երթուղով"
  },
  "gameCenter": {
    "title": "Խաղերի կենտրոն",
    "games": "Խաղեր",
    "ratings": "Վարկանիշներ",
    "leaderboard": "Լիդերների աղյուսակ",
  ...
  "settings": {
    ...
    "darkMode": "Մուգ ռեժիմ",
    "systemMode": "Օգտագործել համակարգի թեման",
    "wallpaper": "Պաստառ",
    "resetWallpaper": "Վերակայել պաստառը",
    "notifications": "Ծանուցումներ",
    "sounds": "Ձայներ",
    "vibration": "Թրթռում",
    "privacy": "Գաղտնիություն",
    ...
    "devices": "Սարքեր",
    "sessions": "Սեսիաներ",
    "connectedApps": "Միացված հավելվածներ",
    "storage": "Պահեստավորում",
    "dataUsage": "Տվյալների օգտագործում",
    "accessibility": "Մատչելիություն",
    "translation": "Թարգմանություն",
    "chatSettings": "Չաթի կարգավորումներ",
    "walletSettings": "Դրամապանակի կարգավորումներ",
    ...
    "payoutSettings": "Վճարումների կարգավորումներ",
    "advanced": "Ընդլայնված",
    "developerOptions": "Մշակողի ընտրանքներ"
  },
  "notifications": {
    "title": "Ծանուցումներ",
    "messageNotifications": "Հաղորդագրությունների ծանուցումներ",
    "callNotifications": "Զանգերի ծանուցումներ",
    "walletNotifications": "Դրամապանակի ծանուցումներ",
    "paymentNotifications": "Վճարումների ծանուցումներ",
    "statementNotifications": "Քաղվածքների ծանուցումներ",
    "payoutNotifications": "Վճարումների ծանուցումներ",
    "settlementNotifications": "Հաշվանցման ծանուցումներ",
    "profileNotifications": "Պրոֆիլի ծանուցումներ",
    "businessNotifications": "Բիզնես ծանուցումներ",
    ...
    "showMessageText": "Ցույց տալ հաղորդագրության տեքստը",
    "muteAll": "Լռեցնել բոլորը",
    "doNotDisturb": "Չանհանգստացնել",
    "quietHours": "Լուռ ժամեր",
    "noNotifications": "Ծանուցումներ դեռ չկան",
    "markAllAsRead": "Նշել բոլորը որպես ընթերցված",
    "notificationHistory": "Ծանուցումների պատմություն"
  },
  "privacy": {
    "title": "Գաղտնիություն",
    "whoCanMessageMe": "Ով կարող է ինձ գրել",
    "whoCanCallMe": "Ով կարող է ինձ զանգահարել",
    "whoCanSeeMyProfile": "Ով կարող է տեսնել իմ պրոֆիլը",
    "whoCanSeeMyPhotos": "Ով կարող է տեսնել իմ լուսանկարները",
    "whoCanSeeMyLastSeen": "Ով կարող է տեսնել իմ վերջին այցելությունը",
    "whoCanSeeMyOnlineStatus": "Ով կարող է տեսնել իմ առցանց կարգավիճակը",
    "whoCanSeeMyPhone": "Ով կարող է տեսնել իմ համարը",
    "blockedUsers": "Արգելափակված օգտատերեր",
    "hiddenUsers": "Թաքցված օգտատերեր",
    "publicContent": "Հանրային բովանդակություն",
    "privateContent": "Մասնավոր բովանդակություն",
    "profileVisibility": "Պրոֆիլի տեսանելիություն",
    "activityVisibility": "Գործունեության տեսանելիություն",
    "readReceipts": "Ընթերցման հաստատումներ",
    "typingStatus": "Գրելու կարգավիճակ",
    "screenshotProtection": "Էկրանանկարից պաշտպանություն",
    "allowProfileShare": "Թույլատրել պրոֆիլի տարածումը",
    "allowQrShare": "Թույլատրել QR-ի տարածումը",
    "allowQrScan": "Թույլատրել QR սկանավորումը",
    "dataPrivacy": "Տվյալների գաղտնիություն",
    "businessVisibility": "Բիզնեսի տեսանելիություն",
    "merchantVisibility": "Մերչանտի տեսանելիություն"
  },
  "security": {
    ...
    "trustedDevices": "Վստահելի սարքեր",
    "activeSessions": "Ակտիվ սեսիաներ",
    "endAllSessions": "Ավարտել բոլոր սեսիաները",
    "suspiciousActivity": "Կասկածելի ակտիվություն",
    "verificationMethods": "Ստուգման մեթոդներ",
    "accountProtection": "Հաշվի պաշտպանություն",
    "loginAlerts": "Մուտքի ազդանշաններ",
    "secureStorage": "Անվտանգ պահեստավորում",
    "sessionManagement": "Սեսիաների կառավարում",
    "antiFraudProtection": "Խարդախությունից պաշտպանություն",
    "transactionSigning": "Գործարքի ստորագրում",
  ...
  "support": {
    "title": "Աջակցություն",
    "contactSupport": "Կապվել աջակցությանը",
    "reportProblem": "Հայտնել խնդրի մասին",
    "sendFeedback": "Ուղարկել կարծիք",
    "helpCenter": "Օգնության կենտրոն",
    "faq": "Հաճախ տրվող հարցեր",
    "liveChat": "Ուղիղ չաթ",
    "emailSupport": "Էլ. փոստի աջակցություն",
    "callSupport": "Հեռախոսային աջակցություն",
    "attachScreenshot": "Կցել էկրանանկար",
    "attachLogs": "Կցել լոգեր",
    "describeIssue": "Նկարագրեք խնդիրը",
    "supportRequestSent": "Աջակցության հարցումը ուղարկվեց",
    "premiumSupport": "Պրեմիում աջակցություն",
    "businessSupport": "Բիզնես աջակցություն",
    "merchantSupport": "Մերչանտ աջակցություն",
    "bankingSupport": "Բանկային աջակցություն",
    "disputeSupport": "Վեճերի աջակցություն"
  },
  "legal": {
    "title": "Իրավական",
    "termsOfService": "Ծառայության պայմաններ",
    "privacyPolicy": "Գաղտնիության քաղաքականություն",
    "communityGuidelines": "Համայնքային կանոններ",
    "paymentTerms": "Վճարման պայմաններ",
    "refundPolicy": "Վերադարձի քաղաքականություն",
    "licenses": "Լիցենզիաներ",
    "openSourceNotices": "Բաց կոդով ծանուցումներ",
    "dataProcessing": "Տվյալների մշակում",
    "compliance": "Համապատասխանություն",
    "merchantTerms": "Մերչանտ պայմաններ",
    "businessTerms": "Բիզնես պայմաններ",
    "bankingTerms": "Բանկային պայմաններ"
  },
  "admin": {
    "title": "Ադմին",
    "dashboard": "Վահանակ",
    ...
    "premium": "Պրեմիում",
    "analytics": "Վերլուծություններ",
    "contentReview": "Բովանդակության ստուգում",
    "systemStatus": "Համակարգի կարգավիճակ",
    "wallets": "Դրամապանակներ",
    "bankAccounts": "Բանկային հաշիվներ",
    "statements": "Քաղվածքներ",
    "payouts": "Վճարումներ",
    "settlements": "Հաշվանցումներ",
    "businessAccounts": "Բիզնես հաշիվներ",
    "merchantAccounts": "Մերչանտ հաշիվներ",
    "giftModeration": "Նվերների մոդերացիա",
    "translationMonitoring": "Թարգմանության մոնիթորինգ",
    "aiMonitoring": "AI մոնիթորինգ",
    "payoutControl": "Վճարումների վերահսկում",
    "disputes": "Վեճեր",
    "fraudAlerts": "Խարդախության ազդանշաններ",
    "complianceQueue": "Համապատասխանության հերթ",
    "accessDenied": "Ադմինի հասանելիություն է պահանջվում"
  },
  "errors": {
    "somethingWentWrong": "Ինչ-որ բան սխալ գնաց",
    "networkError": "Ցանցային սխալ",
    "serverError": "Սերվերի սխալ",
    "timeout": "Ժամանակը սպառվեց",
    ...
    "permissionRequired": "Թույլտվություն է պահանջվում",
    "permissionDenied": "Թույլտվությունը մերժվել է",
    "fileNotSupported": "Ֆայլի ձևաչափը չի աջակցվում",
    "fileTooLarge": "Ֆայլը չափազանց մեծ է",
    "uploadFailed": "Չհաջողվեց վերբեռնել",
    "downloadFailed": "Չհաջողվեց ներբեռնել",
    "statementGenerationFailed": "Չհաջողվեց ստեղծել քաղվածք",
    "messageFailed": "Չհաջողվեց ուղարկել հաղորդագրություն",
    "paymentFailed": "Վճարումը ձախողվեց",
    "transferFailed": "Փոխանցումը ձախողվեց",
    "bankTransferFailed": "Բանկային փոխանցումը ձախողվեց",
    "swiftTransferFailed": "SWIFT փոխանցումը ձախողվեց",
    "payoutFailed": "Վճարումը ձախողվեց",
    "settlementFailed": "Հաշվանցումը ձախողվեց",
    "notEnoughFunds": "Բավարար միջոցներ չկան",
    "insufficientAvailableBalance": "Հասանելի մնացորդը բավարար չէ",
    "insufficientSettlementBalance": "Հաշվանցման մնացորդը բավարար չէ",
    "limitExceeded": "Սահմանաչափը գերազանցված է",
    "cardNotSupported": "Այս քարտը չի աջակցվում",
    "cardVerificationFailed": "Քարտի ստուգումը ձախողվեց",
    "accountVerificationFailed": "Բանկային հաշվի ստուգումը ձախողվեց",
    "qrInvalid": "Անվավեր QR կոդ",
    ...
    "translationUnavailable": "Թարգմանությունը ժամանակավորապես հասանելի չէ",
    "businessVerificationRequired": "Պահանջվում է բիզնեսի ստուգում",
    "merchantVerificationRequired": "Պահանջվում է մերչանտի ստուգում",
    "payoutUnavailable": "Վճարումը ժամանակավորապես հասանելի չէ",
    "settlementPending": "Հաշվանցումը դեռ սպասման մեջ է",
    "complianceReviewRequired": "Պահանջվում է համապատասխանության ստուգում",
    "sourceOfFundsRequired": "Պահանջվում է միջոցների աղբյուր",
    "adminAccessRequired": "Պահանջվում է ադմինի հասանելիություն"
  },
  "success": {
    "saved": "Հաջողությամբ պահպանվեց",
    "sent": "Հաջողությամբ ուղարկվեց",
    "updated": "Հաջողությամբ թարմացվեց",
    "deleted": "Հաջողությամբ ջնջվեց",
    "copied": "Պատճենված է",
    "uploaded": "Հաջողությամբ վերբեռնվեց",
    "downloaded": "Հաջողությամբ ներբեռնվեց",
    "linked": "Հաջողությամբ կապվեց",
    "verified": "Հաջողությամբ ստուգվեց",
    "statementGenerated": "Քաղվածքը հաջողությամբ ստեղծվեց",
    "statementSent": "Քաղվածքը հաջողությամբ ուղարկվեց",
    "paymentCompleted": "Վճարումը հաջողությամբ ավարտվեց",
    "transferCompleted": "Փոխանցումը հաջողությամբ ավարտվեց",
    "bankTransferCompleted": "Բանկային փոխանցումը հաջողությամբ ավարտվեց",
    "payoutCompleted": "Վճարումը հաջողությամբ ավարտվեց",
    "settlementCompleted": "Հաշվանցումը հաջողությամբ ավարտվեց",
    ...
    "bankAccountLinked": "Բանկային հաշիվը հաջողությամբ կապվեց"
  },
  "termsScreen": {
    "paragraph1": "Օգտագործելով Sabi-ը՝ դուք համաձայնում եք պահպանել հարթակի կանոնները, կիրառելի օրենսդրությունը և անվտանգության պահանջները, որոնք սահմանված են դրամապանակի գործառույթների, հաղորդակցությունների, գործարքների և թվային ծառայությունների օգտագործման համար։",
    "paragraph2": "Օգտատերը պատասխանատվություն է կրում ներկայացված տվյալների ճշգրտության, իր սարքերի պաշտպանության, հաշվի հասանելիության վերահսկման և համակարգում կատարվող գործողությունների օրինականության համար։",
    "paragraph3": "Sabi-ն կարող է թարմացնել գործառույթները, անվտանգության պահանջները, օգտագործման կանոնները և ծառայության առանձին պայմանները՝ արտադրանքը բարելավելու, կարգավորող պահանջներին համապատասխանելու և օգտատերերին պաշտպանելու նպատակով։",
