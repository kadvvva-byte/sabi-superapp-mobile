    ...
    mobile: {
      ...
      error: {
        ...
        ai_voice_audio_url_missing:
          "AI صدا صدا url missing",
      },
    },
  },
} as const;

export default FA_AF_AI_MOBILE_LOCALE;